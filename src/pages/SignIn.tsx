      ...
      <div className=" w-full flex lg:w-1/2 justify-center items-center">
        ...
        >
          ...
          <div className="flex py-2 px-3 justify-center">
            <button type="submit" className={`w-40 btn ${signing && "btn-disabled"} btn-outline lg:btn-lg rounded-full mt-4 mb-2`}>{signing ? <span className="loading loading-dots loading-lg"></span> : "SIGN IN"}</button>
          </div>
          <div className="flex justify-center py-2 px-3">
